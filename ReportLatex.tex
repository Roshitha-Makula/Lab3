...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{SDK.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{MetroBundler.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{AppOnEmulator.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{AppOnPhysicalDevice.jpeg}
